...
// import MagicString from 'magic-string'
var addScopeID = postcss.plugin('add-scope-id', function (options) {
...
function compileScopedCSS(code, map, source, options) {
    ...
    process(code, { map: { inline: false, prev: map }, from: source.id, to: source.id }).
    then(
    function (result) {return { code: result.css, map: result.map.toString() };},
    function (error) {
        throw error;
    });
...
var compileCSS = (function () {var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(promise, options) {var style, _ref2, code, map, output;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                        ...
                        compileModule(code, map, style, options).then(function (compiled) {
                            ...
                            return style;
                        }).catch(function (error) {return debug$1(error);}));case 7:if (!(


                        style.scoped === true)) {_context.next = 9;break;}return _context.abrupt('return',
                        compileScopedCSS(code, map, style, options).then(function (compiled) {
                            if (style.$compiled) {
                                compiled.$prev = style.$compiled;
                            }
                        ...
                        style);case 13:case 'end':return _context.stop();}}}, _callee, this);}));return function (_x, _x2) {return _ref.apply(this, arguments);};})();
...
/**
    ...
    function _callee(source, id, content, options, nodes, modules$$1) {var extras, code, template;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
                        ...
                        code = deIndent(source.code);_context.next = 7;return (
...
/* eslint-enable complexity */var processScript = function () {var _ref2 = _asyncToGenerator(_regeneratorRuntime.mark(
    ...
    function _callee2(source, id, content, options, nodes, modules$$1, scoped) {var template, lang, script, map;return _regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                        ...
                        lang = normalizeLang(source.attrs.lang);if (!(
                        ...
                        script = processScriptForStyle(script, modules$$1, scoped, lang, id, options);_context2.next = 16;return (

                            processScriptForRender(script, template, lang, id, options));case 16:script = _context2.sent;return _context2.abrupt('return',

                        { map: map, code: script });case 18:case 'end':return _context2.stop();}}}, _callee2, this);}));return function processScript(_x7, _x8, _x9, _x10, _x11, _x12, _x13) {return _ref2.apply(this, arguments);};}();var processScriptForRender = function () {var _ref3 = _asyncToGenerator(_regeneratorRuntime.mark(
